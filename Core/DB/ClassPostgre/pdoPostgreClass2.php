...
class DB
{
	public static $dsn ="pgsql:host=".POSTGRESQL_HOST.";port=5432;dbname=".POSTGRESQL_NAME."; options='--client_encoding=UTF8' ";
	public static $user = POSTGRESQL_USER;
	public static $pass = POSTGRESQL_PASS;
	...
	public static function add($query, $param = array())
	{
		...
		return (self::$sth->execute((array) $param)) ? (self::getDbh()->lastInsertId() ? self::getDbh()->lastInsertId() : 0 ) : 0;
	}
